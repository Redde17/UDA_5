        ...
        <div class="dropdown-menu dropdown-menu-right">
          ...
          ?>
                <a class="dropdown-item" href="user.php" >
                  ...
                  <?php if($_SESSION["language"] == "it"){echo "Pagina Utente" ;}else{ echo "User Page" ;} ?>
                </a>
                <a class="dropdown-item" href="modifica_inserimento.php" >
                  ...
                  <?php if($_SESSION["language"] == "it"){echo "Aggiungi libro" ;}else{ echo "Add Book" ;} ?>
                </a>
                <a class="dropdown-item" href="grafici.php" >
                  <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-grid-fill" viewBox="0 0 16 16">
                    <path d="M1 2.5A1.5 1.5 0 0 1 2.5 1h3A1.5 1.5 0 0 1 7 2.5v3A1.5 1.5 0 0 1 5.5 7h-3A1.5 1.5 0 0 1 1 5.5v-3zm8 0A1.5 1.5 0 0 1 10.5 1h3A1.5 1.5 0 0 1 15 2.5v3A1.5 1.5 0 0 1 13.5 7h-3A1.5 1.5 0 0 1 9 5.5v-3zm-8 8A1.5 1.5 0 0 1 2.5 9h3A1.5 1.5 0 0 1 7 10.5v3A1.5 1.5 0 0 1 5.5 15h-3A1.5 1.5 0 0 1 1 13.5v-3zm8 0A1.5 1.5 0 0 1 10.5 9h3a1.5 1.5 0 0 1 1.5 1.5v3a1.5 1.5 0 0 1-1.5 1.5h-3A1.5 1.5 0 0 1 9 13.5v-3z"/>
                  </svg>
                  <?php if($_SESSION["language"] == "it"){echo "Amministrazione" ;}else{ echo "Dashboard" ;} ?>
                </a>
                <a class="dropdown-item" onclick="location.href= this + <?php ECHO $lang ?>" >
                  ...
                  <?php if($_SESSION["language"] == "it"){echo "Inglese" ;}else{ echo "Italian" ;} ?>
                </a>
                <div class="dropdown-divider"></div>
                <a class="dropdown-item" style ="color:#F16745;" href="cleanSession.php">
                  <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-door-open-fill" viewBox="0 0 16 16">
                  <path d="M1.5 15a.5.5 0 0 0 0 1h13a.5.5 0 0 0 0-1H13V2.5A1.5 1.5 0 0 0 11.5 1H11V.5a.5.5 0 0 0-.57-.495l-7 1A.5.5 0 0 0 3 1.5V15H1.5zM11 2h.5a.5.5 0 0 1 .5.5V15h-1V2zm-2.5 8c-.276 0-.5-.448-.5-1s.224-1 .5-1 .5.448.5 1-.224 1-.5 1z"/>
                  </svg>
                  <?php if($_SESSION["language"] == "it"){echo "Disconnetti" ;}else{ echo "Quit" ;} ?>
                </a>
          <?php
              }else{
          ?>          
          ...
          ?>
                <a class="dropdown-item " onclick="Form()">
                  ...
                  <?php if($_SESSION["language"] == "it"){echo "Accedi" ;}else{ echo "Log In" ;} ?>
                </a>
                <a class="dropdown-item" onclick="Form()">
                  <span class="iconify" data-icon="fa-solid:user-lock" data-inline="false" ></span>
                  <?php if($_SESSION["language"] == "it"){echo "Registrati" ;}else{ echo "Sign Up" ;} ?>
                </a>
                <div class="dropdown-divider"></div>
                <a class="dropdown-item" onclick="location.href= this + <?php ECHO $lang ?> " >
                  <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-globe2" viewBox="0 0 16 16">
                  ...
                  <?php if($_SESSION["language"] == "it"){echo "Inglese" ;}else{ echo "Italian" ;} ECHO " " .  $_SESSION["language"]; ?>
                </a>
